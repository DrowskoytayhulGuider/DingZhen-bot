...
## 使用方法
### GUI用户
进入程序以后。丁真的回复可能会比较慢，请耐心等待。若对话结束想开始新对话，请点击“重置”。如果你不想让丁真说话，因为这样会使本来就长的等待时间变得更长，你可以点击“雪豹闭嘴”，你又想打开的话就点击“纯纯出声”；如果你不想看到丁真说话的视频（因为这也会很慢很慢，而且效果不佳），请点击“关闭对话”。语音识别使用的谷歌语音识别，这个是开放的，无需注册准备API_Key，可直接使用，但识别速度超慢，不推荐使用。
### 命令行用户
